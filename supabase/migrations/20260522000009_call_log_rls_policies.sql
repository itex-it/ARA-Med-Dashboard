-- Migration: 20260522000009_call_log_rls_policies.sql
-- Purpose: RLS policies for call_log (4 separate policies per D-17)
...
-- Depends on: 20260522000007_call_log.sql (table + RLS enable)
...
CREATE POLICY call_log_tenant_isolation_select ON public.call_log
...
CREATE POLICY call_log_tenant_isolation_insert ON public.call_log
...
-- Prevents assistant from modifying call records (D-17).
-- ============================================================

CREATE POLICY call_log_tenant_isolation_update ON public.call_log
...
-- Assistenz and Viewer cannot delete call records (D-17).
-- ============================================================

CREATE POLICY call_log_tenant_isolation_delete ON public.call_log
...
--   1. RLS enabled on table (in 20260522000007_call_log.sql)
